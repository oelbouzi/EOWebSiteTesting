...
<head>
    <meta charset="utf-8">
    <title>Home</title>
    <link rel="icon" href="../Resources/mytheme/images/favicon.ico">
    <link rel="shortcut icon" href="../Resources/mytheme/images/favicon.ico" />
    <link rel="stylesheet" href="../Resources/mytheme/css/style.css">
    <link rel="stylesheet" href="../Resources/mytheme/css/camera.css">
    <link rel="stylesheet" href="../Resources/mytheme/css/form.css">
    <script src="../Resources/mytheme/js/jquery.js"></script>
    <script src="../Resources/mytheme/js/jquery-migrate-1.1.1.js"></script>
    <script src="../Resources/mytheme/js/superfish.js"></script>
    <script src="../Resources/mytheme/js/forms.js"></script>
    <script src="../Resources/mytheme/js/jquery.ui.totop.js"></script>
    <script src="../Resources/mytheme/js/jquery.equalheights.js"></script>
    <script src="../Resources/mytheme/js/jquery.easing.1.3.js"></script>
    <script src="../Resources/mytheme/js/jquery.ui.totop.js"></script>
    <script src="../Resources/mytheme/js/tms-0.4.1.js"></script>
    <script>
...
<header class="page1">
    <div class="container_12">
        <div class="grid_12">
            <h1><a href="#" onClick="goToByScroll('page1'); return false;"><img src="../Resources/mytheme/images/logo.png" alt="Gerald Harris attorney at law"></a></h1>
    ...
    <div class="container_12">
        <div class="grid_12">
            <div class="slider_wrapper">
                <ul class="items">
                    <li>
                        <img src="../Resources/mytheme/images/spacer.gif" alt="">
    ...
    <div class="container_12">
        ...
        <div class="grid_3">
            <div class="box maxheight">
                <img src="../Resources/mytheme/images/box_img1.jpg" alt="">
        ...
        <div class="grid_3">
            <div class="box maxheight">
                <img src="../Resources/mytheme/images/box_img2.jpg" alt="">
        ...
        <div class="grid_3">
            <div class="box maxheight">
                <img src="../Resources/mytheme/images/box_img3.jpg" alt="">
        ...
        <div class="grid_3">
            <div class="box maxheight">
                <img src="../Resources/mytheme/images/box_img4.jpg" alt="">
    ...
    <div class="container_12">
        ...
        <div class="grid_3">
            <div class="box maxheight1">
                <img src="../Resources/mytheme/images/box1_img1.png" alt="">
        ...
        <div class="grid_3">
            <div class="box maxheight1">
                <img src="../Resources/mytheme/images/box1_img2.png" alt="">
        ...
        <div class="grid_3">
            <div class="box maxheight1">
                <img src="../Resources/mytheme/images/box1_img3.png" alt="">
        ...
        <div class="grid_3">
            <div class="box maxheight1">
                <img src="../Resources/mytheme/images/box1_img4.png" alt="">
...
<footer>
    <div class="container_12">
        <div class="grid_12">
            <div class="copy">
                <a onClick="goToByScroll('page1'); return false;" href="#"><img src="../Resources/mytheme/images/footer_logo.png" alt=""></a>  &copy; 2013 | <a href="#">Privacy Policy</a> <br> Website designed by <a href="http://www.templatemonster.com/" rel="nofollow">TemplateMonster.com</a>
            </div>
        </div>
        <div class="clear"></div>
    </div>
